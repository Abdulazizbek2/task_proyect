...
class AppConstant {
  static List<Color> listColorForCard = [color1, color2, color3, color4];

  static const Color color1 = Color(0xFFFFF2D2);
  static const Color color2 = Color(0xFFFFEBE0);
  static const Color color3 = Color(0xFFD8F5F3);
  static const Color color4 = Color(0xFFEFF5CF);

  static Color textColor1 = const Color(0xFF000000).withOpacity(0.4);
  static Color textColor2 = const Color(0xFF000000).withOpacity(0.65);
  static Color textColor3 = const Color(0xFF000000).withOpacity(0.4);
  static Color textColor4 = const Color(0xFF3364E0).withOpacity(0.4);

  static const Color unSelectedButtonColor1 = Color(0xFFA5A9B2);
  static const Color unSelectedButtonColor2 = Color(0xFFF8F7F5);
  static const Color selectedButtonColor = Color(0xFF3364E0);
  static const Color counterButtonCollor = Color(0xFFEFEEEC);

  static Color textDateColor = const Color(0xFF000000).withOpacity(0.5);

  static const String buttonHome = "assets/home.png";
  static const String buttonSearch = "assets/search.png";
  static const String buttonBag = "assets/bag.png";
  static const String buttonProfile = "assets/profile.png";
  static const String location = "assets/location.png";
  static const String acountImage = "assets/acount_img.png";
  static const String food1 = "assets/food1.png";
  static const String food2 = "assets/food2.png";
  static const String food3 = "assets/food3.png";
  static const String food4 = "assets/food4.png";
  static const String food5 = "assets/food5.png";
  static const String food6 = "assets/food6.png";

  // static const String boxText1 = "Пекарни и кондитерское";
  // static const String boxText2 = "Фастфуд";
  // static const String boxText3 = "Азиатская кухня";
  // static const String boxText4 = "Супы";
  // static const String imageUrl1 =
